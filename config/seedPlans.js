...
const plans = [
    {
        id: uuidv4(),
        name: 'Basic',
        description: 'For individuals and small projects needing basic document search and chatbot functionality',
        price: 799,
        ...
        features: {
            ...
            documentUploadLimit: '3 files/month (max 5MB)',
            vectorChunks: 500,
            searchResults: 1,
            documentTokens: 5000,
            queriesPerMonth: 500,
    ...
    },
    {
        ...
        features: {
            ...
            documentUploadLimit: '50 files/month (max 20MB)',
            vectorChunks: 2000,
            searchResults: 3,
    ...
    },
    {
        ...
        features: {
            ...
            embeddingModel: 'Titan Multimodal Embeddings G1',
            responseModel: 'Llama 3 70B',
            documentUploadLimit: 'Unlimited (max 100MB)',
            vectorChunks: 10000,
            searchResults: 5,
